...
#from resultMetrics import purity_score
...
"""
train_act, test_act, train_label, test_label = model_selection.train_test_split(FEATURES_norm, act_label, test_size=0.2)
